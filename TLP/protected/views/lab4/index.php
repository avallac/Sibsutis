<div class="form">
    <table border="0">
        <tr><td>
                ...
                <?php foreach(array('string', 'terminal', 'terminalTr','nonterminal', 'target') as $e):?>
                    <div class="row">
                ...
                <div class="row buttons">
                    <?php echo CHtml::submitButton('Построить', array('submit' => Yii::app()->createUrl('lab4/index'))); ?>
                </div>
                <?php $this->endWidget(); ?>
            </td><td>
                <?php $this->widget('SaveFormWidget', array('lab' => 4)); ?>
            </td></tr></table>
</div>
<div id="footer"></div>
...
<?php if (isset($labModel['strings'])): ?>
    <table cellspacing="0" class="output">
        <tr><th>Вывод:</th></tr>
        <?php if (is_array($labModel['strings'])): ?>
        <?php foreach ($labModel['strings'] as $line): ?>
            <tr><td><?= $line ?></td></tr>
        <?php endforeach; ?>
        <?php else: ?>
            <tr><td><?= $labModel['strings'] ?></td></tr>
        <?php endif; ?>
    </table>
<?php endif; ?>